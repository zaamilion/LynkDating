...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let uploadedAvatarUrl = document.getElementById('avatarUrl').value || "https://lynkdating.s3.cloud.ru/default-avatar.png";
    ...
    if (profileForm) {
        profileForm.addEventListener('submit', function (e) {
            ...
            if (!isVerified) {
                e.preventDefault();
                alert("Подтвердите Telegram, чтобы продолжить");
                return;
            }
            ...
            const payload = {
                ...
                avatar: uploadedAvatarUrl // Убираем пробелы
            };
            console.log(payload);
            // 5. Отправляем запрос
            fetch('http://localhost:8020/create_anket', {
                method: 'POST',
                headers: {
                ...
                .then(result => {
                    console.log('✅ Профиль успешно создан:', result);
